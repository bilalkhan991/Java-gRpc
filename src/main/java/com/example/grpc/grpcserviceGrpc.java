...
@javax.annotation.Generated(
    ...
    comments = "Source: gRPC_sevice.proto")
public final class grpcserviceGrpc {
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.User.LoginRequest,
    ...
    if ((getLoginMethod = grpcserviceGrpc.getLoginMethod) == null) {
      synchronized (grpcserviceGrpc.class) {
        if ((getLoginMethod = grpcserviceGrpc.getLoginMethod) == null) {
          grpcserviceGrpc.getLoginMethod = getLoginMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new grpcserviceMethodDescriptorSupplier("login"))
                  .build();
          }
        }
     }
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.User.Empty,
    ...
    if ((getLogoutMethod = grpcserviceGrpc.getLogoutMethod) == null) {
      synchronized (grpcserviceGrpc.class) {
        if ((getLogoutMethod = grpcserviceGrpc.getLogoutMethod) == null) {
          grpcserviceGrpc.getLogoutMethod = getLogoutMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpc.User.APIResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new grpcserviceMethodDescriptorSupplier("logout"))
                  .build();
          }
        }
     }
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.Calculator.calculation,
    ...
    if ((getMathMethod = grpcserviceGrpc.getMathMethod) == null) {
      synchronized (grpcserviceGrpc.class) {
        if ((getMathMethod = grpcserviceGrpc.getMathMethod) == null) {
          grpcserviceGrpc.getMathMethod = getMathMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new grpcserviceMethodDescriptorSupplier("math"))
                  .build();
          }
        }
     }
  ...
  private static final int METHODID_MATH = 2;
  ...
  private static abstract class grpcserviceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.GRPCSevice.getDescriptor();
    }
